...
const zh = {
  ...
  home: {
    ...
    about:{
      about: "关于",
      h3: "欢迎来到Blockcerts Signit",
      p1: "现在学生创建，颁发，和雇主验证证书是中心化的。它存在许多问题，学校要成为可信第三方机构就必须受到雇主的信任，证书容易被篡改",
      p2_1: "Blockcerts Signit利用",
      p2_2: "解决上述问题. 目前，为了向后兼容，我们允许学生上传现有证书，然后学校进行证书验证，验证通过后在区块链上颁发该证书",
      p2_3: "同时, ",
      b1: "区块链技术",
      b2: "不可变的",
      b3: "可验证的",
      p3_1: "但是必须注意, 学校保留随时撤销",
      p3_2: "证书的权力",
      i: "已颁发",
      p4: " 我们希望继续向该平台添加更多功能。",
    }
